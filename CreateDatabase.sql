...
SELECT person, name, address, postal, phone, IF (SELECT time FROM Cars WHERE Customer.person = Car.person AND Car.time IS NOT NULL, TRUE, FALSE) AS renting FROM Customer join Car;
